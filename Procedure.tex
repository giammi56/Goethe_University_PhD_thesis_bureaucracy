...
\begin{document}
    ...
    \section*{Printing the thesis}\label{printing}
		...
		Most of the information can be gathered from the \website[https://www.uni-frankfurt.de/42800906/startseite]{Promotionsb\"uro's website},\footnote{The Promotionsb\"uro email address is \emph{probuero@math.uni-frankfurt.de}; you will probably be speaking with Frau Manuela Igelbrink.}
