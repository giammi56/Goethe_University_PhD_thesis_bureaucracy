...
\begin{document}
    ...
    \section*{Printing the thesis}\label{printing}
...
=======
    	The minimum number of copies needed to be printed depends on how many sensors are invited in your committee (minimum $4$, as described in section \nameref{defence}), and on the method chosen to hand in the thesis to the library ($2$ copies with the method suggested in section \nameref{certificate}). The number of copied necessary for the submission is fixed ($4$ copies as describe in section \nameref{certificate}). A good estimate could be $8$ copies i.e., $2$ + $2$ for the submission + $2$ for the sensors + $2$ for the library .
    
    \section*{Summary of needed documents for the submission}\label{submission}
        Most of the information can be gathered from the \website[https://www.uni-frankfurt.de/42800906/startseite]{Promotionsb\"uro's website}, more specifically their \website[https://www.uni-frankfurt.de/42800991/downloads]{download page}. Due to the current situation, please check the previously mentioned website forupdates.
>>>>>>> 78fd269... corona updates
        Below is a summary of what you need to hand off to the Promotionsb\"uro:
        \begin{itemize}
            \item $4$ copies of your dissertation ($2 + 2$), where they will stamp two of them for you to take back to your sensors.
            \textbf{CORONA UPDATE}: $2$ copies out of the $4$ can be directly brought to the sensors without stamps;
            \item $1$ burnt CD with the dissertation on it (you can produce a nice cover using the \file{file} in the \texttt{CD\_cover} directory in the repository) \textbf{OR} $1$ USB stick with the dissertation on it.
    ...
    \section*{Getting your certificate}\label{certificate}
         ...
         \begin{itemize}
            \item According to the \website[http://www.ub.uni-frankfurt.de/dissertationen/abgabe.html\#online]{library website}, you have several ways to hand in your thesis.
                  ...
                  \begin{itemize}
                      ...
                      \item prepare $2$ printed and bound copy of your thesis
                  \end{itemize}
